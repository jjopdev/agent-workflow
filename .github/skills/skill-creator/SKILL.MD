...
3. **Identify the codebase** - Explore the project to find existing patterns:
  ...
  - Search for repeated patterns with `search/codebase`
...
| Type | Location | When |
|------|-----------|--------|
| **Generic** (cross-project) | `~/.copilot/skills/[name]/` | React patterns, testing, Git, etc. |
| **Specific** (single project) | `.github/skills/[name]/` | Module map, PK/SK patterns, env vars |
...
4. Project skills reference personal skills with `> see also ~/.copilot/skills/...`
